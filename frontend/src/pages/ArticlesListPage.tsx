  ...
  return (
    <div className={styles.page}>
      ...
      <header className={styles.header}>
        ...
        <h1 className={styles.title}>Статьи по электроприводам ОВК</h1>
        <p className={styles.lead}>
          Практические материалы для инженеров и снабжения: подбор привода по ТТХ,
          монтаж, сравнение серий и замена аналогов Belimo.
        </p>
      </header>
