...
const SECTION_BARE_RE =
  /^(основные особенности|области применения|преимущества|важные замечания(?:\s+по\s+эксплуатации)?|технические характеристики|комплектация|назначение)$/i;
