...
export const QUIZ_STEPS: Record<QuizStepId, QuizStepCopy> = {
  ...
  dn: {
    ...
    choices: [
      { id: "15", title: "DN 15", hint: "Латунь, резьба" },
      { id: "20", title: "DN 20", hint: "Латунь, резьба" },
      { id: "25", title: "DN 25", hint: "Латунь, резьба" },
      { id: "32", title: "DN 32", hint: "Латунь, резьба" },
      { id: "40", title: "DN 40", hint: "Латунь, резьба" },
      { id: "50", title: "DN 50", hint: "Латунь, резьба" },
      { id: "65", title: "DN 65", hint: "8100Q, фланец ВЧШГ" },
      { id: "80", title: "DN 80", hint: "8100Q, фланец ВЧШГ" },
      { id: "100", title: "DN 100", hint: "8100Q, фланец ВЧШГ" },
      { id: "125", title: "DN 125", hint: "8100Q, фланец ВЧШГ" },
      { id: "150", title: "DN 150", hint: "8100Q, фланец ВЧШГ" },
      {
        id: "skip",
        title: "Пока не знаю",
        hint: "Покажем латунь 8100 и фланцы 8100Q",
      },
    ],
    skippable: true,
  },
  kvs: {
    ...
    choices: [
      ...
      },
      {
        id: "over_40",
        title: "Больше 40 м³/ч",
        hint: "DN 65–150 серии 8100Q и крупные отверстия",
      },
      {
        id: "skip",
        title: "Пока не знаю",
