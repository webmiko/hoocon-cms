...
Не подходит для DA5FU (нужен BR-ML). Конкретный момент и напряжение
...
Назначение:
– Соединяет привод DA5FU с корпусом латунного крана 8100.
– В RFQ выбирается автоматически для серии DA5FU
  (см. комплектацию шаровых кранов).
