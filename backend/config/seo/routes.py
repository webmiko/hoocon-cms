...
PUBLIC_STATIC_ROUTES: dict[str, StaticRouteSeo] = {
    ...
    "/zavod": {
        "title": "Заказ приводов ОВК под своим брендом",
        "description": (
            "OEM электроприводов для вентиляции и ОВК под вашей торговой маркой "
            "напрямую с завода Ningbo Hoocon: CE, UL, EAC. Без посредников."
        ),
    },
    "/gde-kupit": {
        "title": "Где купить",
