...
def test_spec_categories_match_article_families() -> None:
    """Six actuator families from the series table, plus BV / adapters / kits."""
...
def test_classify_series_by_sku_codes() -> None:
    ...
    assert classify_series_category("adapter-br-m", ["BR-M"]) == "adaptery"
    assert classify_series_category("adapter-br-ml", ["BR-ML"]) == "adaptery"
