...
Дата: 2026-07-20  
Обновлено: 2026-07-20 (решения §9 v3 — расписание)  
...
Не в scope: корзина, Stripe, ЛК клиента, WhatsApp (отдельный план).
