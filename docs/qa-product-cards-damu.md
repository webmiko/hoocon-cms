...
Статус: **проход DA\*MU закрыт** (2026-07-29): находки #1–#3 исправлены, выкачены на прод,
`normalize_tech_copy` + `fill_belimo_analogs --force` выполнены. Новые находки — по мере
следующих серий.
