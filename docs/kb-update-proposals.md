...
Правило: править только канон внутренней базы знаний по её инструкции
обновления. Ниже — **кандидаты**, не авто-патч.
...
## 2. Дополнить маршрутизацию стандартов разработки
...
- [ ] Обновить стандарты разработки / README / changelog канона
